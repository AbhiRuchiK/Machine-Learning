...
for i in range(1,len(FormattedData)):
    if FormattedData[i][4]=='99999999':
        r=FormattedData.pop(i)
        print(r)
...
TestingDatamax = np.array(max(TestingData))
NormalizeTestingData=np.array(TestingData/TestingDatamax)
...
TestingDataPricemax=np.array(max(TestingDataPrice))
NormalizeTestingDataPrice=np.array(TestingDataPrice/TestingDataPricemax).T
...
print(TestingDataPricemax)
PredictedPrice=abs(np.dot(NormalizeTestingData[5],Thetas))
print(PredictedPrice)
FinalPrice=np.dot(PredictedPrice,TestingDataPricemax)
print(FinalPrice)
Ans=FinalPrice-TestingDataPrice[5]
print(TestingDataPrice[5])
print(Ans)
 
 
#FinalPrice=(PredictedPrice*TestingDataPricemax)
#Diff=FinalPrice-TestingDataPrice[5]
