...
MaxData = np.array(max(TestingDataPrice))
TestingDataPrice = np.array(TestingDataPrice/MaxData)
...
#print(TestingData)
#print(Thetas)
TestingDataThetaStar = abs(np.dot(TestingData, Thetas.T) )
print(TestingDataThetaStar)
print(TestingDataPrice)
PredictedPrice = TestingDataThetaStar-TestingDataPrice
